...
var WifiWizardDialogStringTable = {
    ...
    defaultError            : 'Your Kindle is unable to connect to the Wi-Fi network "{essid}". --"{error}"--. Press Set Up to enter your password again or manually set up your network. If you have issues connecting your Kindle to Wi-Fi, you can find help at www.amazon.com/devicesupport.',
    passwordFailedError     : 'Your Kindle is unable to connect to the Wi-Fi network "{essid}". The password you entered is incorrect. Try entering your password again or manually setting up your network. If you have issues connecting your Kindle to Wi-Fi, you can find help at www.amazon.com/devicesupport.',
    ...
    failedToConnectError    : 'Your Kindle is unable to connect to the Wi-Fi network "{essid}". Press Set Up to enter your password again or manually set up your network. If you have issues connecting your Kindle to Wi-Fi, you can find help at www.amazon.com/devicesupport.',
    ...
    securityMismatchError   : 'Your Kindle is unable to connect to the Wi-Fi network "{essid}". The security type you entered does not match the security type of the Wi-Fi network. Please manually set up the network again and select the correct security type. If you have issues connecting your Kindle to Wi-Fi, you can find help at www.amazon.com/devicesupport.',
    ...
    apDeniedError           : 'Your Kindle is unable to connect to the Wi-Fi network "{essid}". The access point rejected the connection request. Check your router\'s MAC address filtering settings and try again.',
    ...
    userGuidePart1 : 'To use Airplane Mode, tap Quick Actions',
    userGuidePart2 : 'on the toolbar, then tap Airplane Mode.'
};
