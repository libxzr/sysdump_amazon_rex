...
var BTWizardDialogStringTable = {
    ...
    btWizardHeaderTextForTTS: "Vincula un dispositivo de audio Bluetooth para usar la lectura de texto a voz o el lector de pantalla VoiceView.",
    ...
    passKeyTextMessageFormat: new MessageFormat('"{string}" desea emparejarse con tu Kindle. Confirma que el c\u00f3digo de emparejamiento de "{string}" coincide con el c\u00f3digo siguiente. Si los c\u00f3digos no coinciden exactamente, cancela y vuelve a intentarlo.'),
    confirm: "CONFIRMAR",
