...
var BTWizardDialogStringTable = {
    ...
    passKeyTextMessageFormat: new MessageFormat('"{string}" quer emparelhar com seu Kindle. Verifique se o c\u00f3digo de emparelhamento em "{string}" \u00e9 igual ao c\u00f3digo exibido abaixo. Se os c\u00f3digos n\u00e3o forem exatamente iguais, cancele e tente novamente.'),
    confirm: "CONFIRMAR",
