...
var BTWizardDialogStringTable = {
    ...
    btWizardHeaderTextForTTS: "Veuillez jumeler un appareil audio Bluetooth pour utiliser synth\u00e8se vocale ou le lecteur d\u02bc\u00e9cran VoiceView.",
    rescan: "R\u00c9ANALYSER",
    ...
    passKeyTextMessageFormat: new MessageFormat('"{string}" souhaiterait s\u02bcapparier avec votre Kindle. Veuillez confirmer que le code d\u02bcappariement sur "{string}" correspond au code ci-dessous. Si les codes ne correspondent pas, annulez l\u02bcop\u00e9ration et r\u00e9essayez.'),
    confirm: "CONFIRMER",
